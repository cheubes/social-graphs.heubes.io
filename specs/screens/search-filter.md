...
- Barre de recherche texte, cherchant parmi les `name` des personnages de l'univers, dans la langue courante.
...
- Saisie dans la barre de recherche, en Vue Mosaïque : masque les tuiles des personnages dont le `name` ne correspond pas.
