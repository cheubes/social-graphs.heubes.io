...
Specifications are complete in [`specs/`](specs/); implementation is underway following [`BUILD-PLAN.md`](BUILD-PLAN.md)'s incremental steps (✅ 5/11 — character sheet modal).
