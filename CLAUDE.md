...
Le projet en est au stade des spécifications : tout est documenté dans `specs/`, aucune implémentation n'existe encore. Avant d'écrire du code, lire les fichiers de specs concernés par la tâche.
